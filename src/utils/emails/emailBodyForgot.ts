export const getHTMLBodyForgot = (
  restoreCode: string,
  userName?: string
                                          ...
                                          <td width="100%" style="width: 100%" valign="top">
                                            <table width="100%" style="width: 100%" bgcolor="transparent" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                ...
                                                <td class="main-title" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 28px !important; font-weight: 600; line-height: 1.5;"><span class="main-title" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 28px !important; font-weight: 600; line-height: 1.5;">Password reset email</span></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td width="100%" style="width: 100%" valign="top">
                                            <table width="100%" style="width: 100%" bgcolor="transparent" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td style="width: 32px"></td>
                                                <td class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;"><span class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;">${
                                        ...
                                        <tr>
                                          <td width="100%" style="width: 100%" valign="top">
                                            <table width="100%" style="width: 100%" bgcolor="transparent" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td style="width: 32px"></td>
                                                <td class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;"><span class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;">Let’s reset your password.</span></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
                                          ...
                                          <td width="100%" style="width: 100%" valign="top">
                                            <table width="100%" style="width: 100%" bgcolor="transparent" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                ...
                                                <td width="100%" style="width: 100%;" valign="top">
                                                  <div><!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.mentalreminders.com.link" style="height:56px;v-text-anchor:middle;width:213px;" arcsize="86%" stroke="f" fillcolor="#0FB99A">
                                                      <w:anchorlock/>
                                                      <center>
                                                    <![endif]-->
                                                    <a style="background-color:#272629;color:#ffffff;display:inline-block;font-family: 'Jost', sans-serif;font-size:18px;font-weight:600;line-height:56px;text-align:center;text-decoration:none;text-transform: uppercase;width:213px;-webkit-text-size-adjust:none;">${restoreCode}</a>
                                                    <!--[if mso]>
                                                      </center>
                                                    </v:roundrect>
                                                  <![endif]--></div>
                                        ...
                                        <tr>
                                          <td width="100%" style="width: 100%" valign="top">
                                            <table width="100%" style="width: 100%" bgcolor="transparent" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;"><span class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;">
                                                     If the above button doesn’t work, you can copy and past following info into your browser’s adress bar: <a class="main-link" style="color: #0496FF; font-size: 16px !important;">mentalreminders</a></span></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
                                      <tr>
                                        ...
                                        <tr>
                                          <td width="100%" style="width: 100%" valign="top">
                                            <table width="100%" style="width: 100%" bgcolor="transparent" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;"><span class="main-text" style="color: #1D1C20; font-family: 'Jost', sans-serif; font-size: 16px !important; font-weight: 400; line-height: 1.5;">If you didn’t ask to reset your password, you can disregard this email.</span></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
